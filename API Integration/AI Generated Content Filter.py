...
def submit_data(strength: str = 'Balanced', url="https://api.undetectable.ai/submit", api_key='1710536494338x699896943833058400', document_url="https://api.undetectable.ai/document"): #data, complexity_user_input, purpose_user_input, 
    try:
